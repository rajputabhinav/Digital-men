...
function Communication() {
  ...
  const contactPara ="Take your business communication to the next level with WhatsApp, SMS, and Email Marketing Contact us now to discuss a customized strategy for your brand!";
  ...
  return (
    <div>
      <Header />
      <HeroTemplate heading="Communication Solutions" />

      <div className="w-[80%] m-auto py-17">
        <h1 className={headingClasses}>
          POWERFUL COMMUNICATION SOLUTIONS: <br />
          WHATSAPP, SMS & EMAIL MARKETING
        </h1>
        <p className="text-center mt-10" data-aos="zoom-in">
          At Hire Digital Guru, we help businesses connect with their audience
          through highly effective WhatsApp, SMS, and Email Marketing solutions.
          Whether you want to engage customers, drive conversions, or nurture
          relationships, our communication strategies ensure your message
